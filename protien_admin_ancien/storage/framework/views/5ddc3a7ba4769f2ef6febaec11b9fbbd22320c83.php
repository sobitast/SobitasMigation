    ...
    <div class="page-content">
        <div class="analytics-container">
            <div class="Dashboard Dashboard--full">
                <form role="form" class="form-edit-add" <?php if(@$edit): ?> action="<?php echo e(route('voyager.update_facture_tva' , @$facture->id)); ?>"  <?php else: ?> action="<?php echo e(route('voyager.store_facture_tva')); ?>" <?php endif; ?> method="POST">
                                ...
                                <?php if(@$edit && @$details_facture): ?>
                                    ...
                                    <?php $__currentLoopData = $details_facture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr id="achat<?php echo e($start); ?>">
                                            ...
                                            <td>
                                                <input type="number" step="1" min="0"  <?php if(@$edit): ?> value="<?php echo e(@$details->tva); ?>" <?php else: ?> value="0" <?php endif; ?>
                                                    name="tva<?php echo e($start); ?>" class="form-control"
                                                    id="tva<?php echo e($start); ?>" disabled>
                                            </td>
                                            <td>
                                                <input type="number" step="1" min="0"  <?php if(@$edit): ?> value="<?php echo e(@$details->prix_ttc); ?>" <?php else: ?> value="0" <?php endif; ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sobitas\protien_admin_ancien\resources\views\admin\facturation\facture_tva.blade.php ENDPATH**/ ?>