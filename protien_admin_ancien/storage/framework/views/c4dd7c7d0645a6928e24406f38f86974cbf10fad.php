                            ...
                            <div class="row contacts">
                                <div class="col invoice-to">
                                    ...
                                    <?php if($facture->ville || $facture->region || $facture->code_postale): ?>
                                        <div class="email"><a>  <?php echo e(@$facture->ville); ?>,  <?php echo e(@$facture->region); ?>  <?php echo e(@$facture->code_postale); ?>  </a></div>
                                    <?php endif; ?>
                                ...
                                <div class="col invoice-details">
                                    ...
                                    <div class="address" ><?php echo e(@$facture->livraison_adresse1); ?></div>
                                    <?php endif; ?>
                                    <?php if(@$facture->livraison_adresse2): ?>
                                    <div class="address" ><?php echo e(@$facture->livraison_adresse2); ?></div>
                                    <?php endif; ?>
                                    <?php if($facture->livraison_ville || $facture->livraison_region || $facture->livraison_code_postale): ?>
                                        <div class="email"><a>  <?php echo e(@$facture->livraison_ville); ?>,  <?php echo e(@$facture->livraison_region); ?>  <?php echo e(@$facture->livraison_code_postale); ?>  </a></div>
                                    <?php endif; ?>
...
<?php /**PATH C:\wamp64\www\sobitas\protien_admin_ancien\resources\views\admin\facturation\imprimer_commande.blade.php ENDPATH**/ ?>