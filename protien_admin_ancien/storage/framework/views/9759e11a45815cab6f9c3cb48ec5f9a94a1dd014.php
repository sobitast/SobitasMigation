    ...
    <div class="page-content">
        <div class="analytics-container">
            <div class="Dashboard Dashboard--full">
                <form role="form" class="form-edit-add" <?php if(@$edit): ?> action="<?php echo e(route('voyager.update_facture' , @$facture->id)); ?>"  <?php else: ?> action="<?php echo e(route('voyager.store_facture')); ?>" <?php endif; ?> method="POST">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sobitas\protien_admin_ancien\resources\views\admin\facturation\facture.blade.php ENDPATH**/ ?>