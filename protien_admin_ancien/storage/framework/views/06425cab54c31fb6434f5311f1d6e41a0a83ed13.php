                        ...
                        <ol class="dd-list">
                            ...
                            <li class="dd-item" data-id="<?php echo e($result->getKey()); ?>">
                                <div class="dd-handle" style="height:inherit">
                                    <?php if(isset($dataRow->details->view_order)): ?>
                                        <?php echo $__env->make($dataRow->details->view_order, ['row' => $dataRow, 'dataType' => $dataType, 'dataTypeContent' => $result, 'view' => 'order', 'content' => $result->{$display_column}], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php elseif(isset($dataRow->details->view)): ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sobitas\protien_admin_ancien\vendor\tcg\voyager\resources\views\bread\order.blade.php ENDPATH**/ ?>