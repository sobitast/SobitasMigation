    ...
    <div class="page-content">
        <div class="analytics-container">
            <div class="Dashboard Dashboard--full">
                <form role="form" class="form-edit-add" @if(@$edit) action="{{ route('voyager.update_commande' , @$facture->id) }}"  @else action="{{ route('voyager.store_commande') }}" @endif method="POST">
                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                ...
                                @if ($facture->ville || $facture->region || $facture->code_postale)
                                    <div class="email">  {{ @$facture->ville }},  {{ @$facture->region }}  {{ @$facture->code_postale }}  </div>
                                @endif
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($facture->livraison_ville || $facture->livraison_region || $facture->livraison_code_postale)
                                    <div >  {{ @$facture->livraison_ville }},  {{ @$facture->livraison_region }}  {{ @$facture->livraison_code_postale }}  </div>
                                @endif
                               ...
                               {{--      <tr>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" name="etat">
                                        <option value="nouvelle_commande" @if(@$facture->etat == 'nouvelle_commande') selected @endif>Nouvelle Commande</option>
                                        <option value="en_cours_de_preparation"  @if(@$facture->etat == 'en_cours_de_preparation') selected @endif>En cours de préparations</option>
                                        <option value="prete"  @if(@$facture->etat == 'prete') selected @endif>Prête</option>
                                        <option value="en_cours_de_livraison"  @if(@$facture->etat == 'en_cours_de_livraison') selected @endif>En cours de livraison</option>
                                        <option value="expidee"  @if(@$facture->etat == 'expidee') selected @endif>Expidée</option>
                                        <option value="annuler"  @if(@$facture->etat == 'annuler') selected @endif>Annuler</option>
                                    </select>
            ...
            <table class="table">
                <tr>
                    <th> Commande crée </th><td>{{@$facture->created_at}}</td>
                    <tr>
