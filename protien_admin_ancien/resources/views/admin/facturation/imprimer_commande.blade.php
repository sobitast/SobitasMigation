                            ...
                            <div class="row contacts">
                                <div class="col invoice-to">
                                    ...
                                    @if ($facture->ville || $facture->region || $facture->code_postale)
                                        <div class="email"><a>  {{ @$facture->ville }},  {{ @$facture->region }}  {{ @$facture->code_postale }}  </a></div>
                                    @endif
                                ...
                                <div class="col invoice-details">
                                    ...
                                    <div class="address" >{{ @$facture->livraison_adresse1 }}</div>
                                    @endif
                                    @if(@$facture->livraison_adresse2)
                                    <div class="address" >{{ @$facture->livraison_adresse2 }}</div>
                                    @endif
                                    @if ($facture->livraison_ville || $facture->livraison_region || $facture->livraison_code_postale)
                                        <div class="email"><a>  {{ @$facture->livraison_ville }},  {{ @$facture->livraison_region }}  {{ @$facture->livraison_code_postale }}  </a></div>
                                    @endif
